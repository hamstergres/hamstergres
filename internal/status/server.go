...
func (s *Server) handleMetrics(w http.ResponseWriter, r *http.Request) {
	...
	metric("hamstergres_proxy_schema_revision", "gauge", "Schema revision applied by this Proxy.")
	fmt.Fprintf(&out, "hamstergres_proxy_schema_revision %d\n", snapshot.Sharding.SchemaRevision)
	metric("hamstergres_proxy_topology_revision", "gauge", "Topology revision applied by this Proxy.")
	fmt.Fprintf(&out, "hamstergres_proxy_topology_revision %d\n", snapshot.Sharding.TopologyRevision)
